...
const InstagramFeed = () => {
  const instagramPosts = [
    ...
    },
    {
      ...
      caption: 'Luxury in every detail 💎 #VelouraSociety',
      likes: 3847
    }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
            Share your Veloura moments and get inspired by our beautiful community. 
            Tag us @veloura for a chance to be featured!
          </p>
          <a
            href="https://instagram.com/veloura"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center text-veloura-burgundy hover:text-veloura-burgundy-light transition-colors font-semibold"
          >
        ...
        >
          <p className="text-gray-600 mb-6">
            Share your Veloura moment using <span className="font-semibold text-veloura-burgundy">#VelouraGlow</span>
          </p>
          <a
            href="https://instagram.com/veloura"
            target="_blank"
